...
insert into locataire (id) values (2);
...
values (to_timestamp('DD/MM/YYYY','01/06/2023'),to_timestamp('DD/MM/YYYY','03/06/2023'),150,'yala ça marche !',1,2,1);

select * from location;

insert into parasol_locations values (1,2);
insert into parasol_locations values (75,2);
insert into parasol_locations values (55,2);
insert into parasol_locations values (27,2);
insert into parasol_locations values (7,2);
